...
public class Player extends Entity {
    ...
    public void getPlayerImg() {
        ...
        try {
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("/player/YourCharacter.jpg"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/player/Kimochi_Yokatta.jpg"));

            left1 = ImageIO.read(getClass().getResourceAsStream("/player/YourCharacter.jpg"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/player/Kimochi_Yokatta.jpg"));

            right1 = ImageIO.read(getClass().getResourceAsStream("/player/YourCharacter.jpg"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/player/Kimochi_Yokatta.jpg"));
    ...
    public void update() {
        ...
        gp.cod.checkMonsterCollision(this);
